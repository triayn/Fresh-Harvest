...
<head>
    ...
    <link href="{{ asset('jobie/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
    <link href="jobie{{ asset('/css/style.css') }}" rel="stylesheet">
                        ...
                        <div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
                            ...
                            <div class="card-body contacts_body p-0 dz-scroll  " id="DZ_W_Contacts_Body">
                                <ul class="contacts">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">b
                                            <div class="img_cont">
                                                <img src="images/avatar/4.jpg" class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="has-menu"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./app-calender.html">Customer</a></li>
                        </ul>
                    </li>
                    <li class="has-menu"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./app-profile.html">Buah</a></li>
                            <li><a href="./app-calender.html">Sayur</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">  
                    ...
                    <li class="has-menu"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./app-profile.html">Harian</a></li>
                            <li><a href="./app-calender.html">Mingguan</a></li>
                            <li><a href="./app-calender.html">Bulanan</a></li>
                        </ul>
                    </li>
                </ul>

                <!-- <div class="copyright">
                    <p><strong>Fresh Harvest</strong> © 2024 All Rights Reserved</p>
                    <p>by triayunita</p>
                </div> -->
            </div>
        </div>
