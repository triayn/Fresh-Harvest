    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ url('/') }}" class="brand-logo">
                <h2 style="color: aliceblue" class="brand-title"><b>Fresh</b>Harvest</h2>
            </a>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://github.com/triayn" target="_blank">triayn</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
